...
The stats package examples don't give the standard results:
```
...
---
 > [18,] 0.001 ***
```
Speculation:  this may be an old MinGW bug that Brian Ripley patched
in the last toolchain, i.e. `sqrt(-0)` should be `-0` in C code.