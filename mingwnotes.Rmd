...
`$HOME/RtoolsStatic/packages`; copies are here:
  ...
  - Windows native compiler for 32 bit Windows output [mingw32mingw32_gcc-4.9.2.toolchain.tar.gz](mingw32mingw32_gcc-4.9.2.toolchain.tar.gz)
  - Windows native compiler for 64 bit Windows output [mingw32mingw64_gcc-4.9.2.toolchain.tar.gz](mingw32mingw64_gcc-4.9.2.toolchain.tar.gz)
...
1. FIXED:  [Rf_error problem](https://github.com/kevinushey/RToolsTest): This is a
...
2. Problem in V8:  This works in the 64 bit build, but dies with a segfault
in the 32 bit build:
```
